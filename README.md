...
soqlx-opener/0.1.7 darwin-x64 node-v11.10.1
$ sfdx --help [COMMAND]
USAGE
  $ sfdx COMMAND
...
...
_See code: [src/commands/soqlx/open.ts](https://github.com/ImJohnMDaniel/soqlx-opener/blob/0.1.7/src/commands/soqlx/open.ts)_
<!-- commandsstop -->
